...
const FILES_TO_PUSH = [
  ...
  'server/routes.ts',
  'client/components/HeatmapOverlay.tsx',
  'client/components/HubCard.tsx',
  'client/components/SkeletonLoader.tsx',
  'client/components/SmartPromptBanner.tsx',
  'client/navigation/HomeStackNavigator.tsx',
  'client/navigation/ProfileStackNavigator.tsx',
  'client/navigation/driver/DriverHomeStackNavigator.tsx',
  'client/navigation/driver/DriverProfileStackNavigator.tsx',
  'client/screens/OpenClawScreen.tsx',
  'client/screens/HubDetailScreen.tsx',
  'client/screens/NetworkAnalyticsScreen.tsx',
  'client/screens/CommunityPrestigeScreen.tsx',
  'client/screens/FeedbackScreen.tsx',
...
async function main() {
  console.log('=== Pushing Travony v4.4.0 (OpenClaw) to GitHub ===\n');
  ...
  for (const filePath of FILES_TO_PUSH) {
    ...
    try {
      const params: any = {
        owner, repo: repoName,
        path: filePath,
        message: `v4.4.0: Update ${filePath}`,
  ...
  console.log('=== v4.4.0 Push Complete ===');
}
